 ...
 * CLI version: 2.9.1
 * 
 * Generated: Tue, 01 Nov 2022 00:36:12 GMT
 */

var APP_com_domain_app_LightningMovieAppProject = (function () {
  'use strict';
  ...
  var _from = "@lightningjs/sdk@^5.2.0";
  var _id = "@lightningjs/sdk@5.2.0";
  var _inBundle = false;
  var _integrity = "sha512-4Fy41Ksl6mZOeyodKkfdOMgWsjG1gve2vRqxTydCMgmPofIYuqE5Wqxqovtb3XLyefnDE1qWq5MNbQIvUuXIMQ==";
  ...
  var _resolved = "https://registry.npmjs.org/@lightningjs/sdk/-/sdk-5.2.0.tgz";
  var _shasum = "587a63fe7b95e64129ff0f9d79cead2a679d43cf";
  var _spec = "@lightningjs/sdk@^5.2.0";
  var _where = "C:\\Users\\KQ564BM\\LightningJS\\Lightning Movie App Project";
  var bugs = {
  ...
  const getMovie = async () => {
    let data = await fetch(apiBase + "/movie/top_rated?api_key=" + apiKey + "&language=en-US&page=1");
    return data.json();
  };
  const getSimilarMovies = async movieID => {
    let result = await fetch(apiBase + "/movie/" + movieID + "/similar?api_key=" + apiKey + "&language=en-US&page=1");
    return result.json();
  };
  ...
  class MovieImage extends Lightning$1.Component {
    static _template() {
      return {
        transitions: {
          x: {
  ...
  class Home extends Lightning$1.Component {
    ...
    _handleLeft() {
      ...
      if (this.index > 1) this.tag("MovieImage").patch({
        smooth: {
          x: 500 - (this.index - 1) * 270
        }
      });else {
  ...
  class Movie extends Lightning$1.Component {
    static _template() {
      return {
        Backround: {
          x: 0,
    ...
    set params(args) {
      ...
      this.tag("MovieName").patch({
        text: {
          text: args.title
        }
      });
      this.tag("MovieDetails").patch({
        text: {
          text: args.overview
        }
      });
      this.tag("ReleaseDate").patch({
        text: {
          text: "Release Date:" + args.releaseDate
        }
      });
  ...
  class BootPage extends Lightning$1.Component {
    static _template() {
      return {
        Background: {
          rect: true,
